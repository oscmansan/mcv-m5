...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000,
        ...
        # Add additional variables to track output stride. Necessary to achieve specified output stride.
        ...
        if self.fully_conv:
            ...
            # In the latest unstable torch 4.0 the tensor.copy_ method was changed and doesn't work as it used to be
    ...
    def _make_layer(self, block, planes, blocks, stride=1, multi_grid=None):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            ...
            if self.current_stride == self.output_stride:
                # If so, replace subsampling with a dilation to preserve current spatial resolution.
